...
if (selectedList.length === 0) {
    ...
    for (let r of selectedList) {
        ...
        if (parseInt(r[1]) === x) {
            ...
            selectedList[index][2] = overallList[index]["winnings"]
            ...
            document.getElementById("main").innerHTML += `<div class="card" style="border:1px solid red";>
